...
class UGenerator(nn.Module):
    '''
    Genertor for UGAN using UNET architecture
    :param in_c: number of input channels to generator
    :param out_c: number of output classes (1 for single class segmentation)
    :returns: (batch_size, channels, H, W) mask tensor
    '''
...
class Discriminator(nn.Module):
    '''
    Discriminator for generative adversarial model
    :param in_channels: number of input channels to discriminator
    :returns: probability between 0 and 1 of mask being real or generated
    '''
