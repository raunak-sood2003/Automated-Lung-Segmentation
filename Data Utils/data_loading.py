...
def normalize(torch_Tensor, min_val, max_val):
    '''
    :param torch_Tensor: tensor containing lung CT images
    :param min_val: minimum value CT image is being clipped to
    :param max_val: maximum value CT image is being clipped to
    :return: Normalized CT image (between 0 and 1)
    '''
...
class lungCT_segmentation_DATA(Dataset):
    ...
    :param classifier_pairs: numpy array containing paired lung CT and mask; shape: (# images, 2, 512, 512)
    :param split_type: either 'train', 'val' or 'test'
    :param transforms: any PyTorch transforms for image augmentation
    '''
